...
import TopShipping from "../../../../Components/ComponentsIndustry/TopShipping";
  ...
  return (
    <Container>
      <SizeContainer>
        ...
        <MainContainer>
          <h2>
            Produto <span>Linguiça Salsichão</span>
          </h2>
          <SubTitle>
...
export default ToolsShippingSausage;
